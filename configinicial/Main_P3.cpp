 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-13.0f));
		...
		model = glm::scale(model, glm::vec3(1.50f, 1.50f, 1.50f));
		...
		model = glm::rotate(model, 0.5f, glm::vec3(2.50f, -4.5f, 0.0f)); // use to compare orthographic and perspective projection
